# Generated by Django 4.1.2 on 2022-10-09 18:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('field_name', models.CharField(help_text="Choose a name for the field. Can't contain spaces or special characters", max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('search_field', models.ForeignKey(help_text='TODO', on_delete=django.db.models.deletion.CASCADE, to='ndr_core.ndrsearchfield')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('api_configuration', models.ForeignKey(help_text='TODO', on_delete=django.db.models.deletion.CASCADE, to='ndr_core.apiconfiguration')),
                ('search_form_fields', models.ManyToManyField(help_text='TODO', to='ndr_core.searchfieldformconfiguration')),
            ],
        ),
        migrations.CreateModel(
            name='NdrCorePage',
