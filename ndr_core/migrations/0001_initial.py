...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('api_name', models.CharField(help_text="The (form) name of the API. Can't contain special characters or spaces", max_length=100, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(blank=True, default='', help_text='TODO', max_length=200)),
                ('caption', models.CharField(blank=True, default='', help_text='TODO', max_length=200)),
                ('url', models.URLField(default=None, help_text='TODO', null=True)),
                ('image', models.ImageField(help_text='TODO', upload_to='images')),
                ('image_group', models.ImageField(upload_to='')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value_type', models.IntegerField(choices=[(1, 'String'), (2, 'Integer'), (3, 'Boolean')], default=1, help_text='The type of your value')),
        ...
        migrations.AddField(
            ...
            name='api_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ndr_core.ndrcoreapiimplementation'),
        ),
    ]
