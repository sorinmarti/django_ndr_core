    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_group', models.CharField(choices=[('backgrounds', 'Background Images'), ('elements', 'Element Images'), ('figures', 'Figures'), ('logos', 'Logos'), ('people', 'People')], max_length=100)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value_type', models.CharField(choices=[('string', 'String'), ('integer', 'Integer'), ('boolean', 'Boolean'), ('list', 'List')], default='string', help_text='The type of your value', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('children', models.ManyToManyField(blank=True, null=True, to='ndr_core.ndrcorepage')),
